  ...
  function A01_SetupDemo(setupDemo) {
      ...
      */
      ...
      airline.accountBalance = 0;
       ...
       flight1.contract = factory.newRelationship(NS, 'SC_Pricing', 'CON_101');
       ...
       flight2.contract = factory.newRelationship(NS, 'SC_Pricing', 'CON_101');
       ...
       flight3.contract = factory.newRelationship(NS, 'SC_Pricing', 'CON_101');
      ...
      var contract = factory.newResource(NS, 'SC_Pricing', 'CON_101');
